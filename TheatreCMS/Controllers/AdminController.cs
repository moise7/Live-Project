...
namespace TheatreCMS.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        {
            var admin = new AdminController();
            List<CastMember> castMembersWithoutPhotos = admin.db.CastMembers.Where(p => p.PhotoId == null).OrderBy(p => p.CastMemberID).ToList();
        ...
        {
            var admin = new AdminController();
            List<Sponsor> sponsorsWithoutPhotos = admin.db.Sponsors.Where(p => p.PhotoId == null).OrderBy(p => p.PhotoId).ToList();
        ...
        public static ModelsWithoutPhotos FindModelsNoPics()
        {
            ...
            {
                CastMembers = admin.db.CastMembers.Where(p => p.PhotoId == null).OrderBy(p => p.CastMemberID).
                ...
                Sponsors = admin.db.Sponsors.Where(p => p.PhotoId == null).OrderBy(p => p.PhotoId).
